...
/**
 * Handy utility to get the correct response mime type fro a response.
 *
 * If you return the contents of a gif or png you can use the file name to get
 * the correct response type. For example.
 * 
 * MimeTypes.getMimeType("filename.png")
 * 
 * Will return "image/png" as the content type.
 *
 * If you use the loadMedia method on the HttpNettyResponse it will use this
 * to decide the content type of the response.
 *
 * @author stuartdd
 */
public class MimeTypes {
        ...
        mimeTypes = new HashMap<String, String>() {
            {
                ...
                /**
                 * Additional added by Stuart Davies
                 */
                put(".log", "text/plain");
            }
        };
    ...
    public static String getMimeType(String file) {
        ...
        if (dot >= 0) {
            ...
            if (ext.length() > 2) {
                String mime = mimeTypes.get(ext.toLowerCase(Locale.getDefault()));
                if (mime != null) {
                    return mime;
                }
            }
        }
        throw new ServerGeneralException(HttpResponseStatus.NOT_FOUND, "Resource '" + file + "'. Cannot find content type for this file");
    }
}
